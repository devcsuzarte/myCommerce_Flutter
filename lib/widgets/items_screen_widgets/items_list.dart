...
class _ItemsListState extends State<ItemsList> {
  ...
  Widget build(BuildContext context) {
    return Consumer<ItemData>(builder: (context, productData, child) {
      if (Provider.of<ItemData>(context, listen: false).itemsList.isEmpty) {
        ...
        return Column(
          children: [
            ItemCounter(
                isSaleActivate:
                    Provider.of<ItemData>(context, listen: false).saleIsEnable,
                counter: Provider.of<ItemData>(context, listen: false)
                    .itemsList
                    .length),
            Expanded(
              child: ListView.separated(
                itemBuilder: (context, index) {
                  final item = Provider.of<ItemData>(context, listen: false)
                      .itemsList[index];
                ...
                itemCount: Provider.of<ItemData>(context, listen: false)
                    .itemsList
                    .length,
              ),
            ),
